...
public class EncrypterPBETest {
	...
	private final byte[] toDecryptWithMd5AndDes = new byte[] { 14, -2, -89, -15, 47, 93, 69, 30, 37, -49, -112, 67, -98, -61, -86, -36, -33, 33, 21, 11, -114, -127, 78, 100 };
	private final byte[] toDecryptWithShaAndAes = new byte[] {-125,62,82,87,-73,29,116,-11,-75,-21,32,-91,-123,44,6,-48,23,-11,119,-70,67,-118,116,-8,49,81,-73,-48,-120,46,19,15};
	private final byte[] toDecryptWithShaAndTrippleDes = new byte[] {-45,94,-124,108,17,-99,18,78,-92,45,22,55,-12,52,-128,-93,32,115,78,78,12,9,-40,110};
	private final byte[] toDecryptWithShaAndTwofish = new byte[] {-102,121,113,55,-76,-75,21,-40,3,78,-39,47,-29,55,-40,15,-25,21,61,-92,97,-71,-44,-126,-91,100,72,-66,-20,41,80,-61};
	...
	private static EncrypterFactory encrypterFactory;
	...
	public void shouldWithMd5AndDesDecrypt() throws AbstractEncrypterException {
		EncrypterPBE encrypter = (EncrypterPBE) encrypterFactory.getEncrypter(EncryptionType.PBE_WITH_MD5_AND_DES);
	...
	public void shouldWithShaAndAesDecrypt() throws AbstractEncrypterException {
		EncrypterPBE encrypter = (EncrypterPBE) encrypterFactory.getEncrypter(EncryptionType.PBE_WITH_SHA1_AND_256_AES_CBC_BC);
	...
	public void shouldWithShaAndTrippleDesDecrypt() throws AbstractEncrypterException {
		EncrypterPBE encrypter = (EncrypterPBE) encrypterFactory.getEncrypter(EncryptionType.PBE_WITH_SHA_AND_3_KEY_TRIPPLE_DES_CBC);
	...
	public void shouldWithShaAndTwofishDecrypt() throws AbstractEncrypterException {
		EncrypterPBE encrypter = (EncrypterPBE) encrypterFactory.getEncrypter(EncryptionType.PBE_WITH_SHA_AND_TWOFISH_CBC);

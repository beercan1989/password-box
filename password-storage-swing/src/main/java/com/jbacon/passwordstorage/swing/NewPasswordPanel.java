...
public class NewPasswordPanel extends JPanel {
	...
	public NewPasswordPanel(final MasterPassword profile) {
		...
		GridBagConstraints gbc_passwordNameJTextField = new GridBagConstraints();
		...
		GridBagConstraints gbc_reTypedPasswordJLabel = new GridBagConstraints();
		...
		GridBagConstraints gbc_passwordNotesJTextArea = new GridBagConstraints();
	...
	private boolean passwordsEqual() {
		...
		char[] retypedPassword = reTypedPasswordJPasswordField.getPassword();

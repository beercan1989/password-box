...
public class EditStoredPasswordPanel extends AbstractStoredPasswordPanel {
    ...
    public StoredPassword getUpdatedPassword() throws UnsupportedEncodingException, DecoderException, DataLengthException, IllegalStateException, InvalidCipherTextException {

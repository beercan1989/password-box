...
public class PasswordGeneratorImpl implements PasswordGenerator {
    ...
    private final Random numberGenerator = SecureRandomUtil.getSecureRandom();
     ...
     * 
     * With a <strong>Character Set</strong> of the characters in parameter <em>chars</em> and a <strong>Password Length</strong> of value in parameter <em>length</em>.
     * 
     * @param chars
     *            The array of characters to use.
     * @param length
     ...
     * 
     * With a <strong>Character Set</strong> of <em>Mixed Alpha Numeric</em> characters and a <strong>Password Length</strong> of value in parameter <em>length</em>.
     * 
     * @param length
     *            The length of password to generate.
     */
